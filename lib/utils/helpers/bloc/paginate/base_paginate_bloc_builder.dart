...
abstract class BasePaginateBlocBuilder<T> {
    ...
    Widget build = AppNoInternetOverWidget(
      ...
      child: AppLoadingOverWidget(
        ...
        child: Builder(builder: (context) {
          ...
          if (cubit.isLoading) {
            // Only return loadingWidget if there's no headWidget or cubit.isShowErrorAsPage is true
            return headWidget == null || cubit.isShowErrorAsPage ? loadingWidget() : loadingWidget(true);
          }
          ...
          if (!cubit.isDataEmpty) {
            ...
            if (headWidget == null || cubit.isShowErrorAsPage) {
