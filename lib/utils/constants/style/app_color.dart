...
class AppColor {
  ...
  static const int primaryHex = 0xFF55BCBE;
  static const primaryColor = Color(0xFF55BCBE);
  static const blue = Color(0XFF44C1FF);
  static const green = Color(0XFF00CCAA);

  static const primaryButtonColor = Color(0xFF55BCBE);
